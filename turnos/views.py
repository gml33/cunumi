...
def booking(request):
    ...
    return render(request, 'turnos/booking.html', {
        'weekdays': weekdays,
...
def bookingSubmit(request):
    ...
    return render(request, 'turnos/bookingSubmit.html', {
        'times': hour,
    })
...
def userPanel(request):
    ...
    return render(request, 'turnos/userPanel.html', {
        'user': user,
...
def userUpdate(request, id):
    ...
    return render(request, 'turnos/userUpdate.html', {
        'weekdays': weekdays,
        'validateWeekdays': validateWeekdays,
        'delta24': delta24,
        'id': id,
...
def userUpdateSubmit(request, id):
    ...
    return render(request, 'turnos/userUpdateSubmit.html', {
        'times': hour,
        'id': id,
    })
...
def staffPanel(request):
    ...
    return render(request, 'turnos/staffPanel.html', {
        'items': items,
    })
